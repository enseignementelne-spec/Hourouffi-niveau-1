// Génère les fichiers audio pour la comptine des couleurs via ElevenLabs
...
const API_KEY  = process.env.ELEVENLABS_API_KEY || 'sk_ab61755dce39e59acc8eabbd0fb79eced6323a1e92f036e9'
...
async function main() {
  ...
  for (const ligne of LIGNES) {
    ...
    process.stdout.write(`Génération ligne ${ligne.id}: ${ligne.ar} ... `)
    try {
    ...
    // Pause pour respecter le rate limit ElevenLabs
